...
public class DiscountedPageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    try {
	        ...
	        DiscountedProductDAO dpDAO = new DiscountedProductDAO();

	        // 【修正】左側：商品マスタではなく「自店舗に登録済みの商品」を取得する
	        List<StoreProduct> storeProductList = spDAO.findByStoreId(storeId);

	        // 右側：現在値引き中の商品
	        List<DiscountedProduct> discountList = dpDAO.findByStoreId(storeId);
