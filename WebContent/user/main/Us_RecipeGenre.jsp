		...
		<div class="row g-3">
			<div class="col-6">
				<a href="${pageContext.request.contextPath}/user/main/Us_Recipes.jsp?genre=japanese" class="d-block text-decoration-none">
					<div class="p-4 rounded shadow-sm h-100 d-flex align-items-center justify-content-center border border-dark" style="background-color: #cccccc;"><h3 class="mb-0 text-dark">和食</h3></div>
				</a>
			</div>
			<div class="col-6">
				<a href="${pageContext.request.contextPath}/user/main/Us_Recipes.jsp?genre=western" class="d-block text-decoration-none">
					<div class="p-4 rounded shadow-sm h-100 d-flex align-items-center justify-content-center border border-dark" style="background-color: #9fc5e8;"><h3 class="mb-0 text-dark">洋食</h3></div>
				</a>
			</div>
			<div class="col-6">
				<a href="${pageContext.request.contextPath}/user/main/Us_Recipes.jsp?genre=budget" class="d-block text-decoration-none">
					<div class="p-4 rounded shadow-sm h-100 d-flex align-items-center justify-content-center border border-dark" style="background-color: #b6d7a8;"><h3 class="mb-0 text-dark">節約飯</h3></div>
				</a>
			</div>
			<div class="col-6">
				<a href="${pageContext.request.contextPath}/user/main/Us_Recipes.jsp?genre=manmeshi" class="d-block text-decoration-none">
					<div class="p-4 rounded shadow-sm h-100 d-flex align-items-center justify-content-center border border-dark" style="background-color: #ea9999;"><h3 class="mb-0 text-dark">漢メシ</h3></div>
				</a>
			</div>
		</div>
	</div>
